...
class TestAffineSphereDropping: public SceneTestBase {
...
public:
    ...
    TestAffineSphereDropping() {
...

        {
            ...
            b3SphereShape shpere_shape;
            shpere_shape.set_as_sphere(1.0);

            b3FixtureDef sphere_fd;
            sphere_fd.m_shape = &shpere_shape;
    ...
    ~TestAffineSphereDropping() override {
    ...
    static TestBase* create() {
        return new TestAffineSphereDropping;
    }
};

static int test_index = register_test("Affine Scene Test", "Sphere Dropping", TestAffineSphereDropping::create);
