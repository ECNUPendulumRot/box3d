...
class PlaneSphereTest : public Test {

public:

    PlaneSphereTest() : Test() {
    ...
    static Test* create() {
        return new PlaneSphereTest();
    }
};

static int test_index = register_test("Manifold", "Plane and Sphere", PlaneSphereTest::create);