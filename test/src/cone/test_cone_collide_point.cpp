...
class TestConeCollidePoints : public Test {

public:

    TestConeCollidePoints() {
    ...
    static Test* create() {
        return new TestConeCollidePoints;
    }
};


static int test_index = register_test("Cone", "cone collide points", TestConeCollidePoints::create);