...
class TestBoxStack: public SceneTestBase {
...
public:
    ...
    TestBoxStack() {
        ...
        for (int32 i = 0; i < cube_count; ++i) {
            ...
            cube_shape.set_as_box(cube_hf_lengh, cube_hf_lengh, cube_hf_lengh);

            b3Vector3r p(0, 0, cube_hf_lengh + 2 * i * cube_hf_lengh);
            b3Vector3r q(0, 0, 0);
            b3Vector3r v(0, 0, 0);
            b3Vector3r w(0, 0, 0);
