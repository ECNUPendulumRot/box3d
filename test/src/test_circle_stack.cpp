//
// Created by 米诺 on 2024/11/8.
//
#include "test.hpp"

class TestCircleStack :public Test {
...
static Test* create() {
    return new TestCircleStack;
};

};

static int test_index = register_test("Sphere Scene Test", "Circle Stack", TestCircleStack::create);