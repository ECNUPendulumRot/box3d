...
class TestAffineSphereRest: public SceneTestBase {
...
public:
    ...
    static TestBase* create() {
        return new TestAffineSphereRest;
    }
};

static int test_index = register_test("Affine Scene Test", "Sphere Resting", TestAffineSphereRest::create);
