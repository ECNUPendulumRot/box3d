...
execute_process(
  COMMAND "D:/Git/cmd/git.exe" --git-dir=.git show-ref "tags/3.4.0"
  WORKING_DIRECTORY "E:/box3d/out/build/x64-Release/_deps/eigen-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'E:/box3d/out/build/x64-Release/_deps/eigen-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'E:/box3d/out/build/x64-Release/_deps/eigen-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
...
if(init_submodules)
  execute_process(
    COMMAND "D:/Git/cmd/git.exe" --git-dir=.git submodule update --recursive --init 
    WORKING_DIRECTORY "E:/box3d/out/build/x64-Release/_deps/eigen-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
