...
void b3Fixture::create_fixture(b3BlockAllocator *block_allocator, 
...
void b3Fixture::synchronize(b3BroadPhase *broad_phase, 
							const b3TransformD &transform1, const b3TransformD &transform2) {
  if (m_proxy_count == 0) {
	return;
  }
